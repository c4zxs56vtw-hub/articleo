...
export const Badge = ({
  ...
  const variants = {
    ...
    primary: "bg-indigo-50 text-indigo-900 border border-indigo-150 dark:bg-indigo-950/40 dark:text-indigo-300 dark:border-indigo-900",
    ...
    warning: "bg-yellow-50 text-yellow-800 border border-yellow-250 dark:bg-yellow-950/40 dark:text-yellow-300 dark:border-yellow-900",
