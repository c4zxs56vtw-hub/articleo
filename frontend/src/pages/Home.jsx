...
export const Home = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <section className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 p-5 mb-8 shadow-sm">
          ...
          <div className="flex gap-2.5">
            ...
            {(searchVal || selectedCategory || ordering !== '-created_at') && (
              <button
                ...
                className="px-4 py-2.5 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-600 dark:text-slate-300 rounded-lg text-sm font-semibold transition-colors duration-200"
              >
                Réinitialiser
              </button>
            )}
