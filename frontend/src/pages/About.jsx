  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="text-center mb-12">
        <h1 className="text-3xl sm:text-4xl font-extrabold text-slate-800 mb-4 uppercase tracking-wider">
      ...
      <section className="bg-white rounded-2xl border border-slate-100 p-6 sm:p-8 shadow-sm mb-8">
        <h2 className="text-xl font-bold text-slate-850 mb-4 flex items-center gap-2">
          <BookOpen className="w-5.5 h-5.5 text-indigo-900" />
      ...
      <section className="bg-white rounded-2xl border border-slate-100 p-6 sm:p-8 shadow-sm mb-8">
        <h2 className="text-xl font-bold text-slate-850 mb-6 flex items-center gap-2">
          <UserCheck className="w-5.5 h-5.5 text-indigo-900" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="p-5 rounded-xl bg-slate-50 border border-slate-150">
            <h3 className="font-bold text-sm text-indigo-900 uppercase tracking-wide mb-3">
              En tant que Visiteur
            </h3>
            <ul className="space-y-3.5 text-xs sm:text-sm text-slate-600">
              <li className="flex items-start gap-2">
                <span className="w-1.5 h-1.5 bg-indigo-900 rounded-full mt-2 flex-shrink-0" />
